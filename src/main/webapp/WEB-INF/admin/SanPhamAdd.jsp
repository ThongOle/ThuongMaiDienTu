...
<c:url value="/admin/sanphamadd2" var="urlAdd" />
...
<section class="content">
	<div class="body_scroll">
		...
		<s:form action="${urlAdd }" method="post">
								...
								<div class="row clearfix">
									<div class="col-sm-12">
										<div class="form-group">
											<input type="text" class="form-control tensanpham"
												placeholder="Xin hãy nhập tên sản phẩm" name="tensanpham" />
										</div>
									</div>
								</div>
								<br>
											...
											<ul class="scroll-item danhmuc0">
												<c:if test="${not empty lstDanhMuc0}">
													<c:forEach var="dm" items="${lstDanhMuc0}">
														<li class="category-item" data-value=${dm.id }
															data-name="${dm.tenDanhMuc }" data-cap="0">
															<p style="margin-top: 0px; margin-bottom: 0px">${dm.tenDanhMuc }</p>
						...
						<div class="card">
							<div class="body">
								<label>Đã chọn:</label>&nbsp;&nbsp;&nbsp;<label id="daChon"
									data-value="0" style="color: red; border: none; "></label><br>
									<input id="tendanhmuc"
									data-value="0" style="color: red; border: none; display: none;" name="tendanhmuc" >
								
								<button type="submit" class="btn btn-primary tieptheo"
									disabled="disabled">
									Tiếp theo<i class="fa fa-fw fa-lg fa-check-circle"></i>
								</button>
								<input id="dmId" name="dmId" type="hidden">
							</div>
						</div>
					</div>
