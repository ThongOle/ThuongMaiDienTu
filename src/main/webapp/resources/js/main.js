...
/*----------------------------------------*/
 ...
 /*----------------------------------------*/
 	...
 	$('.hm-minicart').on({
 		mouseenter: function () {
        $(this).children('.hm-minicart-trigger').addClass('is-active');
        $(this).children('.minicart').slideDown();
    	},mouseleave: function () {
       $(this).children('.hm-minicart-trigger').removeClass('is-active');
        $(this).children('.minicart').slideUp();
    	}
 	})
...
/* 11. Category Menu
/*----------------------------------------*/
	 $('#danhMuc').on('click', '.rx-parent', function(){
	    $('#danhMuc .rx-child').slideToggle();
